      ...
      <div className={`shadow-xl z-10 h-screen w-32 -left-1/2 lg:relative lg:left-0 duration-200 ${isActive && 'left-0 w-[80%] absolute'}`}>
        ...
        <div className=''>
          ...
          <div className='flex justify-center lg:justify-start items-center  hover:bg-blue-200 py-3'>
            <Link className='w-full flex flex-col items-center' to='/dashboard/'>
              ...
              <span className={`font-bold lg:relative lg:duration-200 ${isActive && 'lg:left-0 lg:relative'}`}>Consultas</span>
            </Link>
          </div>

          <div className='flex justify-center lg:justify-start items-center relative hover:bg-blue-200 py-3'>
            <Link className='w-full flex flex-col items-center' to='/dashboard/registrar-consulta'>
              ...
              <span className='font-bold lg:relative lg:left-0 lg:duration-200 text-center'>Registrar Consulta</span>
            </Link>
          </div>

          {/* <div className='flex justify-center lg:justify-start hover:bg-blue-200 py-3'>
            <Link className='w-full flex flex-col items-center' to='/dashboard/reportes-doctor'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>

              <span className='font-bold lg:relative lg:left-0 lg:duration-200 text-center'>Reportes</span>
            </Link>
          </div> */}
